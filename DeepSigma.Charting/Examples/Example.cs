...
namespace DeepSigma.Charting.Examples
{
    internal class Example
    {
        private void ExampleChartGeneration()
        {
            ...
            // Build the PlotModel using a builder pattern (see WinUI library implementation for details).
            //var builder = ChartBuilderRegistry.CreateWithDefaults();
            //var plot = builder.Build(chart);
